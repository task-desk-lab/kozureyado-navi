...
<p class="rating">★4.48 <span>（楽天トラベル 口コミ670件）</span></p>
</header>
...
<h2>お食事</h2><figure class="ph"><img src="meal_kaiseki.jpg" alt="お食事イメージ" loading="lazy"><figcaption class="credit">※写真はイメージです</figcaption></figure><p class="amb-t">夕食はレストラン(バイキング)で。食事の口コミ評価は★4.45</p>
...
<div class="cta">
<p class="pre">★4.48・口コミ670件のこの宿、空いてる日をチェック</p>
